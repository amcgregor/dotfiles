...
* Python Virtual Environment support that beats virtualenvwrapper:
** Automatically activate any VENV you @cd@ to, and deactivate when leaving.
** If your projects are stored in @~/Projects@ you can just type the name of a project to go there and activate.
** When entering the root of a virtual environment, if a source folder exists you will automatically go there.
